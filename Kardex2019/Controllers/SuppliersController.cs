...
namespace Kardex2019.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "SupplierId,Name,Address,Phone")] Suppliers suppliers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "SupplierId,Name,Address,Phone")] Suppliers suppliers)
        {
            if (ModelState.IsValid)
            {
